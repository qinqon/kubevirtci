...
func (r *releaser) createGithubRelease(tag, releaseTarballPath string) error {
	...
	ts := oauth2.StaticTokenSource(
		&oauth2.Token{AccessToken: r.opts.githubToken},
	)
	...
	_, _, err = client.Repositories.UploadReleaseAsset(context.Background(), r.opts.githubOrg, r.opts.githubRepo, *release.ID, nil, f)
	if err != nil {
